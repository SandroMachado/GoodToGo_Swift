...
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (BOOL)getObjectValue:(id __nullable * __null_unspecified)obj forString:(NSString * __nonnull)string errorDescription:(NSString * __nullable * __null_unspecified)error;
- (UITextPosition * __nonnull)getNewPositionForPosition:(UITextPosition * __nonnull)position inTextInput:(id <UITextInput> __nonnull)textInput oldValue:(NSString * __nullable)oldValue newValue:(NSString * __nullable)newValue;
@end
